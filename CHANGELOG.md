...
- **Local Notifications**: Added support for local notifications to notify users of migration completion or failure.
- **Notification Permission**: Added a prompt to request notification permission from the user.
